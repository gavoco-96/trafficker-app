// Trafficker Pro v2.2 — modularizado (Fase 1)
...
function paisNombre(code){ return PAISES_INFO[code]?.n || code || "Desconocido"; }
function paisBandera(code){ return PAISES_INFO[code]?.f || "🌐"; }
